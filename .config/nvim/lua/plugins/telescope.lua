return {
  {
    ...
    keys = {
      ...
      },
      {
        "<Leader>ff",
        function()
          require("telescope.builtin").find_files({ cwd = require("util").root() })
        end,
      ...
      },
      {
        "<Leader>sg",
        function()
          require("telescope.builtin").live_grep({ cwd = require("util").root() })
        end,
      ...
      },
      {
        "<Leader>sw",
        function()
          require("telescope.builtin").grep_string({ cwd = require("util").root() })
        end,
        mode = "v",
