...
Uncomment the source line in `.gdbinit` file, then remove the `pwndbg` folder to [uninstall](https://github.com/pwndbg/pwndbg/discussions/1155#discussioncomment-6362340).  
```bash
